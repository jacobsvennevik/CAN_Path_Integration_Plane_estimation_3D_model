...
class NetworkConfig:
    ...
    velocity_gains:   float = 20 #Kernel offset, amount of shift added to each kernel
...
class ExperimentConfig:
    ...
    def __post_init__(self):
        self.scale = (2 * np.pi) / self.grid_spacing      # rad per metre
        self.speed = self.target_speed_rad / self.scale   
